...
if __name__ == '__main__':
    ...
    for class_name in CLASSES:
        clean_files = glob.glob(os.path.join(args.clean_dir, class_name, '*.wav'))
        for clean_file in clean_files:
            ...
            for noise_name in NOISE_LIST:
                noise_files = glob.glob(os.path.join(args.noise_dir, noise_name, '**', '*.wav'), recursive=True)
                ...
                noisy_split_path = os.path.join(args.noisy_dir, f'{noise_name}_noisy_test', class_name)
